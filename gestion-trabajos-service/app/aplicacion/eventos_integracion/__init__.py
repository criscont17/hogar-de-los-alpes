...
un campo interno no debe romper a Pagos, Operaciones, Crédito ni a los partners.
El sufijo de versión permite publicar un esquema nuevo sin dejar de emitir el
anterior; la política es mantener como máximo dos versiones activas por evento
(la vigente y la deprecada) hasta que los consumidores migren.
"""
