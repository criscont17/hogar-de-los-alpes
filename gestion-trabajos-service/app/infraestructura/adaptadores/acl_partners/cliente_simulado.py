...
class ClientePartnerSimulado:
    ...
    En producción sería un cliente HTTP, SOAP o de webhooks con timeout. Aquí
    registra lo recibido y permite simular una caída para observar el circuit
    breaker sin depender de sistemas externos.
    """
