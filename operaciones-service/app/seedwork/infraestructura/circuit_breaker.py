...
No sabe nada de partners: envuelve cualquier invocación y deja de intentarla mientras
el destino se considera caído. Así una dependencia rota falla rápido en lugar de
consumir tiempo e hilos del resto del sistema.
"""
