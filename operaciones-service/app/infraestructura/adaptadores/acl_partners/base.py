...
class AdaptadorDePartnerBase(AdaptadorDePartner):
    ...
    Un partner nuevo declara su `PARTNER_ID` y traduce en tres direcciones: la solicitud
    que envía, el estado que consulta y los hechos que quiere recibir. El envío resiliente
    lo aporta el `SincronizadorDePartner` inyectado, así que ningún adaptador reimplementa
    reintentos ni circuit breaker.
    """
