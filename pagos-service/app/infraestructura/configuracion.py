...
# Comandos de Saga para PagosBC
PULSAR_TOPICO_COMANDOS_PAGO = _texto(
    "PULSAR_TOPICO_COMANDOS_PAGO", "persistent://public/default/comandos-pago"
)
PULSAR_SUSCRIPCION_COMANDOS_PAGO = _texto("PULSAR_SUSCRIPCION_COMANDOS_PAGO", "pagos-saga-comandos")
PULSAR_CONSUMIR_COMANDOS_PAGO = _booleano("PULSAR_CONSUMIR_COMANDOS_PAGO", True)
