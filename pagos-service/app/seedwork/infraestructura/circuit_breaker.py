...
No sabe nada de PSPs: envuelve cualquier invocación y deja de intentarla mientras
el destino se considera caído. Así una pasarela de pago rota falla rápido en lugar
de consumir tiempo e hilos del resto del sistema.
"""
